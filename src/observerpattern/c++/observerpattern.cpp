...
class ISubject {
    public:
    virtual ~ISubject(){};
    virtual void Attach(IObserver *observe) = 0;
    virtual void Detach(IObserver *observe) = 0;
...
class Subject : public ISubject {
    ...
    void Attach(IObserver *observe) override {
        list_observer_.push_back(observe);
    }

    void Detach(IObserver *observe) override {
